...
from models import Task, parse_deadline_string
...
class AppGUI:
    ...
    def setup_input_widgets(self):
        ...
        tk.Label(input_frame, text="Task Title:").grid(row=0, column=0, padx=5, sticky='w')
        tk.Entry(input_frame, textvariable=self.title_var, width=40).grid(row=0, column=1, columnspan=3, padx=5, pady=5)
        
        tk.Label(input_frame, text="Date:").grid(row=1, column=0, padx=5, sticky='w')
        tk.Entry(input_frame, textvariable=self.date_var, width=15).grid(row=1, column=1, padx=5, pady=5)
        
        tk.Label(input_frame, text="Time:").grid(row=1, column=2, padx=5, sticky='w')
        tk.Entry(input_frame, textvariable=self.time_var, width=10). grid(row=1, column=3, padx=5, pady=5)
